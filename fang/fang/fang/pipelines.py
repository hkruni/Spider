...
class InsertTitlePipe(object):
    ...
    def insertTitleSql(self, tx,item):
        ...
        #sql = "insert into fang_%s"%(hour)
        sql = "insert into fang"
        sql_insert = sql + " (site,title,shortDescription,category,style,tag,origin_url,new_url,mb,pixel,size,format) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        
#         sql_insert = '''insert into fang 
#         (site,title,shortDescription,category,style,tag,origin_url,new_url,mb,pixel,size,format) 
#         values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'''
        tx.execute(sql_insert,(item['site'],item['title'],item['shortDescription'], 
